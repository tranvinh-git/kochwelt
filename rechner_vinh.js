    // Zutatenliste als Array (für 4 Basis-Portionen)
    const zutaten = [
    ...
    function berechne() {
      ...
      const basisPortionen = 4; // Basis-Portionenanzahl (z. B. 4 Portionen)
    ...
    window.onload = function() {
      document.getElementById("portionen").value = 4; // Standardwert setzen
